...
*/
 ...
 $ACCESS_PWD='pommes'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access
 ...
 'user'=>"root",#required
 'pwd'=>"", #required
 'db'=>"trueartist_blog",  #optional, default DB
